...
3. Inspect project contracts when relevant.
...
7. Verify and finalize.
   ...
   - Confirm required top-level sections are present when the PiFlow template is used.
   ...
   - If the local project is a git repository, commit only `inputs/req.md` and directly related review files changed by this skill.
...
- Commit only the requirement document and directly related review artifacts changed by this skill.
