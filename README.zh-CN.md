...
| `plan-doc-maker` | 在 `docs/plans/` 下生成已评审的中文方案文档，包括提案、解决方案、架构方案、实施方案、迁移方案、重构方案或升级方案。 | `skills/plan-doc-maker/SKILL.md`, `skills/plan-doc-maker/assets/plan-template.md`, `skills/plan-doc-maker/agents/openai.yaml` |
