...
| `add-skill-lib` | 将 Git 托管的 skill library clone 到 PiFlow 的 `skill-libraries/<library-name>`，提取模板字段，完成 skill 暴露、`path + locator` 校验和 runtime self-test 回归。 | `skills/add-skill-lib/SKILL.md`, `skills/add-skill-lib/agents/openai.yaml` |
